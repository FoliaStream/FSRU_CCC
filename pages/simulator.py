...
#     # st.markdown(
#     #     "**Note on Cost Trends:** The sharp step-down in the Base TCO after 2040 and 2045 reflects the progressive "
#     #     "tightening of FuelEU Maritime compliance thresholds. For a vessel operating on fossil fuels, "
#     #     "these compliance deficits translate directly into substantial financial penalties which are completely negated by the "
#     #     "rehabilitated well-to-wake greenhouse gas profile of the capture technology."
#     # )
...
#         'CCC_FuelEU_Penalty', 'CCC_IMO_Levy', 'CCC_CAPEX_Outflow', 'CCC_TCO', 'Annual_Savings', 'Cash_Flow', 'Cum_Cash_Flow'
#     ]
...
with tab3:
    st.markdown("### Physical & Regulatory Framework Rules (v2)")
