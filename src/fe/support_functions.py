...
#         ccc_tco = ccc_ets + ccc_fueleu + ccc_imo + ccc_opex
#         annual_savings = base_tco - ccc_tco

#         rows.append(dict(
#             Year=yr, Carbon_Price=carbon_price, FuelEU_Target=target_ghg,
#             Base_CO2=base_co2, Base_Fuel_Cost=base_fuel_cost, Base_ETS_Fee=base_ets,
#             Base_FuelEU_Penalty=base_fueleu, Base_IMO_Levy=base_imo,
#             Base_Opex=base_opex, Base_TCO=base_tco,
#             CCC_Installed=int(is_installed), CCC_CO2_Generated=ccc_co2_generated,
#             CCC_CO2_Captured=ccc_co2_captured, CCC_CO2_Net=ccc_co2_net,
#             CCC_Fuel_Cost=ccc_fuel_cost, CCC_Maint=ccc_maint, CCC_Opex=ccc_opex,
#             CCC_ETS_Fee=ccc_ets, CCC_FuelEU_Penalty=ccc_fueleu, CCC_IMO_Levy=ccc_imo,
#             CCC_CAPEX_Outflow=ccc_capex_outflow, CCC_TCO=ccc_tco,
...
#     # ---------------- Financial metrics ----------------
#     cash_flows, disc_cash_flows, cum, cum_disc = [], [], 0.0, 0.0
